        ...
        <section class="content" style="padding: 10px;">
            <div class="container-fluid">
                ...
                <div class="card" style="margin-bottom: 20px">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{  route('editSimple') }}" enctype="multipart/form-data">
                            @csrf
                            <fieldset class="form-group">
                                <label for="vat">VAT</label><span style="color: red;">*</span>
                                <input type="number" class="form-control" id="vat" name="vat" value="{{ isset($setting) ? $setting->vat : '' }}" required>
                            </fieldset>
                            <fieldset class="form-group">
                                <label for="service_charge">Service Charge</label><span style="color: red;">*</span>
                                <input type="number" class="form-control" id="service_charge" value="{{ isset($setting) ? $setting->service_charge : '' }}" name="service_charge">
                            </fieldset>
                            <fieldset class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="main-img-preview">
                                            <img class="thumbnail img-preview" src="{{ isset($setting) ? $setting->logo : '' }}"
