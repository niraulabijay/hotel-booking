...
@section('headers')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/admin/users/add_system_user">Add</a></li>
        </ol>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('register_system_user')}}" enctype="multipart/form-data">
                            @if(count($errors)>0)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    @foreach($permissions as $permission)
                                        <input name="permissions[]" type="checkbox" value="{{$permission->title}}">{{ $permission->title }}
                                    @endforeach
                                </div>
