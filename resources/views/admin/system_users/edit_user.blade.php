...
@section('headers')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/admin/users/edit_system_user/{{$user->id}}">Edit</a></li>
        </ol>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('post_edit_system_user',$user->id)}}" enctype="multipart/form-data">
                            @if(count($errors)>0)
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label for="country" class="col-md-4 col-form-label text-md-right">{{ __('Country') }}</label><span--}}
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label for="prof_pic" class="col-md-4 col-form-label text-md-right">Profile Picture</label>--}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">@foreach($permissions as $permission)
                                    <br>
                                    <input name="permissions[]" type="checkbox" value="{{$permission->title}}"
                                    @foreach($selected_permissions as $selected) @if($selected == $permission->title) checked @endif @endforeach>
                                    {{ $permission->title }}
                                @endforeach
                                </div>
                            </div>
